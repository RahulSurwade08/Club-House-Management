...
# creating the frames in the window
    ...
    def startpage(self):
        ...
        self.heading = Label(self.main, text="Club House Management", font=('Centaur 20 bold') ,fg='black',bg="yellow",relief=SUNKEN)
        self.heading.place(x=45, y=20)

        # name

        self.name = Label(self.main, text="Member's Name", font=('arial 12 bold'),bg="lightblue")
...
# button to perform a command
        ...
        self.submit = Button(self.main, text="Add Membership", font="aried 12 bold",width=15, height=2, bg='lightgreen',command=self.add_membership)
        self.submit.place(x=120, y=340)

#show log

        sql2 = "SELECT count(id) FROM membership    "
       ...
       #  display the logs in our frame
        ...
        self.logs = Label(self.main, text=" Total\n  Members", font=('arial 10 bold'), fg='black',bg="lightblue")
...
# funtion to call submit button
    ...
    def add_membership(self):
        ...
        if self.val1 == '' or self.val2 == '' or self.val3 == '' or self.val4 == '' or self.val5 == '':
          tkinter.messagebox.showinfo("Warning", "Please Fill Up All Boxes")
            ...
            sql = "INSERT INTO 'membership' ( name, age, gender, location, phone) VALUES(?, ?, ?, ?, ? )"
            c.execute(sql, (self.val1, self.val2, self.val3, self.val4, self.val5))
            conn.commit()
            tkinter.messagebox.showinfo("Success", "\n Membership for " + str(self.val1) + " has been created")
        self.main.destroy()
    ...
    def showdetails(self):
        ...
        count1=0
        count2=0
        clmnname=['mem no','name','age','gender','location','contact no']
    ...
    def updatee(self):
        ...
        self.id = Label(self.updateframe, text="Search membership Number To Update", font=('arial 12 bold'),fg="red")
    ...
    def update1(self):
        ...
        # execute sql
        sql = "SELECT * FROM membership WHERE id LIKE ?"
        ...
        self.uname = Label(self.updateframe, text="Member's Name", font=('arial 14 bold'))
...
#buttons for update and delete
    ...
    def update2(self):
            ...
            query = "UPDATE membership SET name=?, age=?, gender=?, location=?, phone=? WHERE id LIKE ?"
    ...
    def deletee(self):
            ...
            self.id = Label(self.deleteframe, text="Search membership Number To Delete", font=('arial 12 bold'), fg="red")
            self.id.place(x=0, y=12)
    ...
    def delete1(self):
        ...
        for self.row in self.res:
            ...
            self.phone = self.row[5]
        # creating the update form
        self.uname = Label(self.deleteframe, text="Member's Name", font=('arial 14 bold'))
        self.uname.place(x=0, y=140)
    ...
    def delete2(self):
        sql2 = "DELETE FROM membership WHERE id LIKE ?"
...
window.title("Club House Management")
